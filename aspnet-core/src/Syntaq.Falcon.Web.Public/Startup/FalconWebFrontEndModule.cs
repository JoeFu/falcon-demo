...
namespace Syntaq.Falcon.Web.Public.Startup
{
    ...
    public class FalconWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FalconWebFrontEndModule(IWebHostEnvironment env, FalconEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FalconWebFrontEndModule).GetAssembly());
        }
    }
}
