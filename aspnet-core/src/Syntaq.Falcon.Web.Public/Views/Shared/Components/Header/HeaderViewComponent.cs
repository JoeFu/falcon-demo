...
using Syntaq.Falcon.Web.Public.Startup;
using Syntaq.Falcon.Web.Session;

namespace Syntaq.Falcon.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FalconViewComponent
    {
